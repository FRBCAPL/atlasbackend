...
// REAL ladder players from the Google Sheets (499-under ladder)
const realLadderPlayers = [
  ...
  { rank: 11, name: 'Tony Neumann', fargoRate: 450, wins: 5, losses: 1, status: 'ACTIVE' },
...
const cleanupLadderPlayers = async () => {
  try {
    ...
    // DELETE ALL REMAINING LADDER PLAYERS (to start fresh with real data)
    ...
    console.log('\n🎉 Ladder cleanup completed!');
    console.log(`✅ Total real players: ${realLadderPlayers.length}`);
