// Clear existing unified collections and run migration
// This script will clean up any existing unified data and start fresh
...
async function clearAndMigrate() {
    try {
        ...
        console.log('🧹 Clearing existing unified collections...\n');
        
        // Connect to MongoDB
        await mongoose.default.connect(process.env.MONGODB_URI);
        console.log('✅ Connected to MongoDB');
        
        // Clear existing unified collections
        const db = mongoose.default.connection.db;
        
        try {
            await db.collection('unifiedusers').drop();
            console.log('✅ Dropped unifiedusers collection');
        } catch (error) {
            console.log('ℹ️  unifiedusers collection did not exist');
        }
        
        try {
            await db.collection('leagueprofiles').drop();
            console.log('✅ Dropped leagueprofiles collection');
        } catch (error) {
            console.log('ℹ️  leagueprofiles collection did not exist');
        }
        
        try {
            await db.collection('ladderprofiles').drop();
            console.log('✅ Dropped ladderprofiles collection');
        } catch (error) {
            console.log('ℹ️  ladderprofiles collection did not exist');
        }
...
// Run the clear and migrate process
clearAndMigrate();
