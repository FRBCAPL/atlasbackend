...
const importData = async () => {
  try {
    ...
    // Clear existing ladder players
    console.log('🗑️  Clearing existing ladder players...');
...
console.log(`
🚀 CLEAR AND IMPORT LADDER DATA
===============================

📝 INSTRUCTIONS:
1. This will CLEAR all existing ladder players
2. Then import all 50 players from your 499 ladder
3. Including "No Rating" players
4. No email/pin generated - accounts claimed later
